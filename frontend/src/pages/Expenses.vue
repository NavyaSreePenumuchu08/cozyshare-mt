...
export default {
  ...
  methods: {
    ...
    async fetchHouseholdMembers() {
      ...
      try {
        const res = await axios.get(
          ` https://cozyshare-mt-backend.onrender.com/api/households/${this.householdCode}/members`,
        )
    ...
    async fetchSettlements() {
      if (!this.householdCode) return
      try {
        const res = await axios.get(' https://cozyshare-mt-backend.onrender.com/api/settlements', {
          params: { householdCode: this.householdCode },
        })
    ...
    async deleteExpense(id) {
      try {
        await axios.delete(` https://cozyshare-mt-backend.onrender.com/api/expenses/${id}`)
    ...
    async settlePayment(settlementId) {
      ...
      try {
        await axios.post(' https://cozyshare-mt-backend.onrender.com/api/settlements', {
          householdCode: this.householdCode,
    ...
    async undoPayment(settlementMongoId) {
      try {
        await axios.delete(
          ` https://cozyshare-mt-backend.onrender.com/api/settlements/${settlementMongoId}`,
        )
        await this.fetchSettlements()
